...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="expediente" && $field=="dias_restantes")
	{
		if ($value >= 0 && $value <=1)
{ 
	if ($data["semaforo"]==1 or $data["vacio"]==0)
	{
		$value =$data["estatus"];
	}
	else
	{
		...
		{
			$value ='<img src="images/m2.jpg" alt="" /> <img src="images/end.png" alt="" /> <br>'.' Estatus '.$data["estatus"].' ¡COMPLETADO! con '.$value.' días restantes'; 
		}
		else
		{
			$value ='<img src="images/m2.jpg" alt="" /> <img src="images/now.png" alt="" /> <br>'.$value.' días restantes para completar el estatus: '.$data["estatus"];
		}
	}
	//$color="black"; 
}
...
{ 
	...
	else
	{
		if ($data["finalizado"]==1)
		{
				$value ='<img src="images/m1.jpg" alt="" /> <img src="images/end.png" alt="" /> <br>'.' Estatus '.$data["estatus"].' ¡COMPLETADO! con '.$value.' días restantes'; 
		}
		else
		{
				$value ='<img src="images/m1.jpg" alt="" /> <img src="images/now.png" alt="" /> <br>'.$value.' días restantes para completar el estatus: '.$data["estatus"];
		}
	}
	//$color="black"; 
...
else
{
	...
	{
		if($data["finalizado"]==1) {
				$value ='<img src="images/m3.jpg" alt="" /> <img src="images/end.png" alt="" /> <br>'.' Estatus '.$data["estatus"].' ¡COMPLETADO! con '.abs($value).' días de retraso';  
		}
		else
		{
				$value ='<img src="images/m3.jpg" alt="" /> <img src="images/now.png" alt="" /> <br>'.abs($value).' días de retraso para completar el estatus: '.$data["estatus"];
		}
	}
	//$color="red"; 
}
...
//$value="<span style='color: " . $color . "'>" . $value . "</span>"; ;
		return $value;
				...
				if($table=="seguimiento_expediente" && $field=="dias_restantes")
	{
		if ($value >= 0 && $value <=1)
{ 
	if ($data["tipo_estatus"]==1)
	{
		$value ="";
	}
	else
	{
		if ($data["finalizado"]==1)
		{
			$value ='<img src="images/m2.jpg" alt="" /> <img src="images/end.png" alt="" /> <br>'.' Estatus ¡COMPLETADO! con '.$value.' días restantes'; 
		}
		else
		{
			$value ='<img src="images/m2.jpg" alt="" /> <img src="images/now.png" alt="" /> <br>'.$value.' días restantes para completar el estatus';
		}
	}
	//$color="black"; 
}
...
{ 
	...
	else
	{
		if ($data["finalizado"]==1)
		{
				$value ='<img src="images/m1.jpg" alt="" /> <img src="images/end.png" alt="" /> <br>'.' Estatus ¡COMPLETADO! con '.$value.' días restantes';
		}
		else
		{
				$value ='<img src="images/m1.jpg" alt="" /> <img src="images/now.png" alt="" /> <br>'.$value.' días restantes para completar el estatus';
		}
	}
	//$color="black"; 
...
else
{
	...
	else
	{
		if($data["finalizado"]==1)
		{
				$value ='<img src="images/m3.jpg" alt="" /> <img src="images/end.png" alt="" /> <br>'.' Estatus ¡COMPLETADO! con '.abs($value).' días de retraso';
		}
		else
		{
				$value ='<img src="images/m3.jpg" alt="" /> <img src="images/now.png" alt="" /> <br>'.abs($value).' días de retraso para completar el estatus';
		}
	}
	//$color="red"; 
}
...
;
		return $value;
				...
				if($table=="expediente_vista01" && $field=="dias_restantes")
	{
		if ($value >= 0 && $value <=1)
{ 
	if ($data["semaforo"]==1 or $data["vacio"]==0)
...
//$value="<span style='color: " . $color . "'>" . $value . "</span>"; ;
		return $value;
				...
				if($table=="seguimiento_expedientevista01" && $field=="dias_restantes")
	{
		if ($value >= 0 && $value <=1)
{ 
	if ($data["tipo_estatus"]==1)
...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="expediente" && $field=="idempleado")
	{
		return "idjefatura = '23'";
	}
				if($table=="expediente" && $field=="idjefatura")
	{
		return "realiza_pedido = 1";
	}
				if($table=="02 Reporte por departamento" && $field=="jefatura")
	{
		return "realiza_pedido=1";
	}
				if($table=="06 Reporte por analista" && $field=="idempleado")
	{
		return "idjefatura=23";
	}
				if($table=="08 Reporte por efectividad" && $field=="idempleado")
	{
		return "idjefatura=23";
	}
				if($table=="expediente_vista01" && $field=="idempleado")
	{
		return "idjefatura = '23'";
	}
	return "";
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="expediente" && $field=="numero_pedido")
	{
		return siguiente_recibo();;
	}
				if($table=="seguimiento_expediente" && $field=="fecha_estatus1")
	{
		return now();
	}
				if($table=="seguimiento_expediente" && $field=="dias_agregados")
	{
		return 0;
	}
				if($table=="seguimiento_expedientevista01" && $field=="dias_agregados")
	{
		return 0;
	}
	return "";
...
function siguiente_recibo()
{
	$strSQL = "SELECT MAX(numero_pedido) AS maximo FROM expediente";
	$rs = db_query($strSQL);
